...
public class DirReductionTest {
    ...
    public void testRandomDirReduc()  {
        ...
        assertArrayEquals(doDirReduc(u15), DirReduction.dirReduc(u15), "random 15 directions");
        String[] u30 = randDir(30);
        assertArrayEquals(doDirReduc(u30), DirReduction.dirReduc(u30), "random 30 directions");
    }
}